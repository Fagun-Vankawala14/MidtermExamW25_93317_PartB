...
public class VendingMachineItem {
   ...
   // }
    ...
    //I've Commented out the above and moved the methods to their own classes in order to refactor the code and promote Loose Coupling alongside High Cohesion.
